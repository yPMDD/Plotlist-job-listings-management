    ...
    <div class=" mb-10 pr-60 pl-60 pt-20">
        <h1 class=" pb-10 font-bold text-center">Upload your file</h1>
                <div class="p-2 w-full">
                    <form action="/user/cv/store" method="post">
                        @csrf
                  <label for="price" class="block mb-2 text-sm font-medium text-gray-900 ">Title </label>
                  <input type="text" value="" name="title" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder=" ex: my resume" >
                  @error('title')
